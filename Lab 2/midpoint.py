...
def midpoint(start_coordinate: Coordinate, end_coordinate: Coordinate) -> list[Coordinate]: 
...
def main(): 
    ...
    display.set_caption("MidPoint - Nisham Ghimire") 
